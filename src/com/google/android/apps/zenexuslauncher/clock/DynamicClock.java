package com.google.android.apps.zenexuslauncher.clock;
...
import com.google.android.apps.zenexuslauncher.utils.ActionIntentFilter;
...
public class DynamicClock extends BroadcastReceiver
{
    ...
    private static ClockLayers getClockLayers(Context context, int iconDpi, boolean normalizeIcon) {
        ...
        try {
            ...
            if (metaData != null) {
                int levelPerTickIcon = metaData.getInt("com.google.android.apps.zenexuslauncher.LEVEL_PER_TICK_ICON_ROUND", 0);
                if (levelPerTickIcon != 0) {
                    ...
                    layers.mHourIndex = metaData.getInt("com.google.android.apps.zenexuslauncher.HOUR_LAYER_INDEX", -1);
                    layers.mMinuteIndex = metaData.getInt("com.google.android.apps.zenexuslauncher.MINUTE_LAYER_INDEX", -1);
                    layers.mSecondIndex = metaData.getInt("com.google.android.apps.zenexuslauncher.SECOND_LAYER_INDEX", -1);
                    layers.mDefaultHour = metaData.getInt("com.google.android.apps.zenexuslauncher.DEFAULT_HOUR", 0);
                    layers.mDefaultMinute = metaData.getInt("com.google.android.apps.zenexuslauncher.DEFAULT_MINUTE", 0);
                    layers.mDefaultSecond = metaData.getInt("com.google.android.apps.zenexuslauncher.DEFAULT_SECOND", 0);
                    if (normalizeIcon) {
