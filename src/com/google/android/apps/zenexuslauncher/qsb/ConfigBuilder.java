package com.google.android.apps.zenexuslauncher.qsb;
...
import com.google.android.apps.zenexuslauncher.NexusLauncherActivity;
import com.google.android.apps.zenexuslauncher.search.AppSearchProvider;
import com.google.android.apps.zenexuslauncher.search.nano.SearchProto.a_search;
import com.google.android.apps.zenexuslauncher.search.nano.SearchProto.b_search;
import com.google.android.apps.zenexuslauncher.search.nano.SearchProto.c_search;
import com.google.android.apps.zenexuslauncher.search.nano.SearchProto.d_search;
...
public class ConfigBuilder {
    ...
    private b_search bZ(final AppInfo appInfo, final int n) {
        ...
        b.el = dm.toString();
        b.ek = new Intent("com.google.android.apps.zenexuslauncher.search.APP_LAUNCH", dm.buildUpon().appendQueryParameter("predictionRank", Integer.toString(n)).build()).toUri(0);
        return b;
    }
