...
public class SmartspaceBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        byte[] byteArrayExtra = intent.getByteArrayExtra("com.google.android.apps.zenexuslauncher.extra.SMARTSPACE_CARD");
        if (byteArrayExtra != null) {
            com.google.android.apps.zenexuslauncher.smartspace.nano.SmartspaceProto.a a = new com.google.android.apps.zenexuslauncher.smartspace.nano.SmartspaceProto.a();
            try {
