package com.google.android.apps.zenexuslauncher.smartspace;
...
import com.google.android.apps.zenexuslauncher.smartspace.nano.SmartspaceProto.b;
import com.google.android.apps.zenexuslauncher.smartspace.nano.SmartspaceProto.c;
import com.google.android.apps.zenexuslauncher.smartspace.nano.SmartspaceProto.e;
import com.google.android.apps.zenexuslauncher.smartspace.nano.SmartspaceProto.i;
import com.google.android.apps.zenexuslauncher.utils.ColorManipulation;
...
public class SmartspaceCard {
    ...
    private com.google.android.apps.zenexuslauncher.smartspace.nano.SmartspaceProto.d cG(final boolean b) {
        final c ch = this.cH();
        if (ch != null) {
            com.google.android.apps.zenexuslauncher.smartspace.nano.SmartspaceProto.d d;
            if (b) {
                d = ch.cL;
            } else {
                d = ch.cM;
    ...
    private boolean cL(final com.google.android.apps.zenexuslauncher.smartspace.nano.SmartspaceProto.d d) {
        boolean b = false;
    ...
    private String cO(final boolean b, final String s) {
        final com.google.android.apps.zenexuslauncher.smartspace.nano.SmartspaceProto.d cg = this.cG(b);
