...
import com.google.android.apps.zenexuslauncher.smartspace.nano.SmartspaceProto.*;
...
public class NewCardInfo {
    ...
    public Bitmap getBitmap(final Context context) {
        com.google.android.apps.zenexuslauncher.smartspace.nano.SmartspaceProto.f fVar = this.di.cx;
        if (fVar == null) {
            return null;
        }
